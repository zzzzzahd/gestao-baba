...
// Ícone SVG Personalizado e Restaurado: Presidente Tático com Braço Proporcional
const TacticianPresidentIcon = ({ className }) => (
  <svg
  ...
  >
    ...
    <defs>
      {/* Gradiente Metálico Suave para o Corpo (Branco a Cinza Muito Claro) */}
    ...
    <g transform="translate(50,50)"> 
      {/* Silhueta do Presidente Unificada: Cabeça */}
      ...
      {/* Braço Direito (Anatomicamente Proporcional) estendido e tático */}
      <path
      ...
      {/* Mão (Conectada ao Braço) Apontando para o Centro da Prancheta */}
      ...
      <g transform="translate(35, 20)"> {/* Posição e Inclinação Tática na mão */}
        ...
        {/* Prendedor da Prancheta (Cyan Elétrico Original) */}
        <path d="M -5 -11 L 5 -11 L 3 -8 L -3 -8 Z" fill="var(--cyan-electric)" />
        
        {/* Táticas Puras Desenhandas na Prancheta (X, O e Seta Tática) */}
...
const LogoTacticoRestaurado = ({ size = 'large' }) => {
  const sizes = {
    small: {
      icon: 'w-16 h-16',
      text: 'text-2xl',
  ...
  return (
    <div className="flex flex-col items-center text-center animate-fade-in p-4">
      {/* Container Integrado do Ícone SVG Unificado e Restaurado */}
      <div className="relative mb-6 flex items-center justify-center w-full">
        {/* NOVO Ícone SVG Anatomicamente Proporcional e Tático */}
        <TacticianPresidentIcon 
      ...
      <div className="space-y-1">
        ...
        {/* Subtítulo Clean e Totalmente Azul */}
...
export default LogoTacticoRestaurado;
