...
describe('generateBalancedTeams', () => {
  // generateBalancedTeams balanceia por balance_level (Nível geral, 1–3),
  // que vem de player_rating_summary.avg_level — final_rating não é mais
  // usado aqui (fica só para o perfil/stats do jogador).
