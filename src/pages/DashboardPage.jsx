      ...
      <div className="max-w-xl mx-auto px-6 mt-12 space-y-6">
        ...
        {isPresident && (
          <div className="card-glass p-6 rounded-[2.5rem] border border-cyan-electric/20 bg-cyan-electric/5 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-[10px] font-black uppercase tracking-widest text-cyan-electric">
                  Convite do Grupo
                </h3>
              ...
              <>
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-6 bg-cyan-electric hover:bg-cyan-400 text-black rounded-2xl font-black uppercase text-[10px] flex items-center gap-2 active:scale-95 transition-all shadow-lg shadow-cyan-electric/20"
                  >
                    <Copy size={14} /> Copiar
                  </button>
                </div>
